...
function Projects() {
    ...
    const addProject = () => {
        setProjects(prevItem => [...prevItem, {projectName: projectName, description: description, technologies: technologies}]);
    }
  return (
    <div className='border-b border-neutral-900 pb-4'>
        ...
        <div>
            ...
            {Projects.map(({projectName, description, technologies})=>(
