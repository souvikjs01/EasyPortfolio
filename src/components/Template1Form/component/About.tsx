...
import { AboutImage } from "@/recoilState";
...
const About: React.FC<AboutProps> = ({ data }) => {
  ...
  const [url, seturl] = useRecoilState(AboutImage);
      ...
      <div className="flex flex-wrap">
          ...
          <div className="relative flex items-center cursor-pointer justify-center group">
            <div className="relative">
              ...
              <img
                ...
                height={500}
                width={500}
                className="rounded-2xl group-hover:opacity-70"
              />
              {/* <Image
        ...
        >
          <textarea
            value={abouttext_}
            onChange={(e) => {
              setabouttext_(e.target.value);
            }}
            cols={30}
            className="mt-10 mb-5 outline-none bg-transparent tracking-tight h-24 font-light pr-16 resize-none"
            ...
            <PopoverContent className="w-full bg-transparent text-white">
              ...
              <div className="flex flex-row">
                <input
                  value={ResumeLink_}
                  onChange={(e) => {
                    setResumeLink_(e.target.value);
                  }}
                  type="text"
                  className="mr-2 w-full h-8 pl-1 outline outline-blue-500 outline-1 rounded-lg text-neutral-400 bg-transparent"
                />
                <button>Add</button>
              </div>
            </PopoverContent>
