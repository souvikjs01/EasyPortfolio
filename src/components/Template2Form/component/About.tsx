  ...
  return (
    <div className="text-center p-10 py-10 flex flex-col">
        ...
        <motion.div variants={container(1)} initial="hidden" animate="visible" className="pb-12">
            <textarea cols={35} className="mt-10 bg-transparent tracking-tight w-full sm:w-[50%] lg:px-0 h-24 font-light pr-16 resize-none" placeholder="Write a brief summary..."></textarea>
