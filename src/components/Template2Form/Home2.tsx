...
import { AboutText, Address, Email, GithubNavbar, InstaNavbar, LinkedInNavbar, Mobile, Name, Resume, SocialHandles, Summary, Technology_, WhatYouAre, experienceState, projectState, temp1Form } from "@/recoilState";
    ...
    <div className="overflow-x-hidden text-neutral-300 bg-black">
      <div className="fixed top-0 -z-10 h-full w-full">
       ...
       <div className="container mx-auto px-8">
          <Navbar />
          <About  Name_={data.HeroSection?.Name} WhatYouAre_={data.HeroSection?.WhatYouAre} Summary_={data.HeroSection?.Summary}/>
