...
export async function POST(request: NextRequest, response: NextResponse) {
    ...
    try {
        ...
        const {
            heroImage, navgithub, navlinkedin, navinsta ,template, username, findUser, whatyouare, summary, resume, abouttext, address, mobile, sociallinks, technology, projects, experience, email
        } = reqBody;
        ...
        if (existingPortfolio) {
            ...
            const updatedPortfolio = await Data.findOneAndUpdate(
                { findUser },
                {
                    heroImage, navgithub, navlinkedin, navinsta, template, username, whatyouare, summary, resume, abouttext, address, mobile, sociallinks, technology, projects, experience, email
                },
